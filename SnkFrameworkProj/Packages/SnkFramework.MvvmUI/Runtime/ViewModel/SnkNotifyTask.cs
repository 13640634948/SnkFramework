...
#nullable enable
        ...
        /// </summary>
        public sealed class SnkNotifyTask : INotifyPropertyChanged
        {
            ...
            private SnkNotifyTask(Task task, Action<Exception>? onException)
            {
                Task = task;
            ...
            private void NotifyProperties(Task task)
            {
                ...
                if (task.IsCanceled)
                {
                    propertyChanged(this, SnkPropertyChangedEventArgsCache.Instance.Get(nameof(Status)));
                    propertyChanged(this, SnkPropertyChangedEventArgsCache.Instance.Get(nameof(IsCanceled)));
                }
                else if (task.IsFaulted)
                {
                    propertyChanged(this, SnkPropertyChangedEventArgsCache.Instance.Get(nameof(Exception)));
                    propertyChanged(this, SnkPropertyChangedEventArgsCache.Instance.Get(nameof(InnerException)));
                    propertyChanged(this, SnkPropertyChangedEventArgsCache.Instance.Get(nameof(ErrorMessage)));
                    propertyChanged(this, SnkPropertyChangedEventArgsCache.Instance.Get(nameof(Status)));
                    propertyChanged(this, SnkPropertyChangedEventArgsCache.Instance.Get(nameof(IsFaulted)));
                }
                else
                {
                    propertyChanged(this, SnkPropertyChangedEventArgsCache.Instance.Get(nameof(Status)));
                    propertyChanged(this, SnkPropertyChangedEventArgsCache.Instance.Get(nameof(IsSuccessfullyCompleted)));
                }
                propertyChanged(this, SnkPropertyChangedEventArgsCache.Instance.Get(nameof(IsCompleted)));
                propertyChanged(this, SnkPropertyChangedEventArgsCache.Instance.Get(nameof(IsNotCompleted)));
            }
            ...
            /// <param name="task">The task to watch.</param>
            /// <param name="onException">Callback to be run when an error happens</param>
            public static SnkNotifyTask Create(Task task, Action<Exception>? onException = null)
            {
                return new SnkNotifyTask(task, onException);
            }
            ...
            /// <param name="onException">Callback to be run when an error happens</param>
            public static SnkNotifyTask<TResult> Create<TResult>(
                Task<TResult> task,
                TResult? defaultResult = default,
                Action<Exception>? onException = null)
                where TResult : class
            {
                return new SnkNotifyTask<TResult>(task, defaultResult, onException);
            }
            ...
            /// <param name="onException">Callback to be run when an error happens</param>
            public static SnkNotifyTask Create(Func<Task> asyncAction, Action<Exception>? onException = null)
            {
        ...
        /// </summary>
        /// <typeparam name="TResult">The type of the task result.</typeparam>
        public sealed class SnkNotifyTask<TResult> : INotifyPropertyChanged
            where TResult : class
        {
            private readonly Action<Exception>? _onException;
            ...
            /// <param name="onException">Callback to be run when an error happens</param>
            internal SnkNotifyTask(Task<TResult> task, TResult? defaultResult, Action<Exception>? onException)
            {
            ...
            private void NotifyProperties(Task task)
            {
                ...
                {
                    propertyChanged(this, SnkPropertyChangedEventArgsCache.Instance.Get(nameof(Result)));
                    propertyChanged(this, SnkPropertyChangedEventArgsCache.Instance.Get(nameof(Status)));
                    propertyChanged(this, SnkPropertyChangedEventArgsCache.Instance.Get(nameof(IsSuccessfullyCompleted)));
                }
                propertyChanged(this, SnkPropertyChangedEventArgsCache.Instance.Get(nameof(IsCompleted)));
