...
namespace SnkFramework.NuGet.Features
{
    ...
    {
        class SnkSubsetConfiguration : SnkConfigurationBase
        {
            private string prefix;
            private SnkConfigurationBase parent;
            public SnkSubsetConfiguration(SnkConfigurationBase parent, string prefix)
            {
                this.parent = parent;
                this.prefix = prefix;
            }
            ...
            public override ISnkConfiguration Subset(string prefix)
            {
